...
export interface ICatalogConfig {
  ORGANIZATION_DEFAULT_VALUE: number;
  LEGAL_PERMISSION_DEFAULT_VALUE: any;
  TYPE_ATTENTION_DEFAULT_VALUE: any;
  ADDRESS_DEFAULT_VALUE: any;
  GROUP_DEFAULT_vALUE: any;
  CATEGORY_DEFAULT_VALUE: any;
  SECTOR_DEFAULT_VALUE: any;
  TYPE_ATTENTION_EXTRA_DEFAULT_VALUE: any;
  TYPE_FREQUENCY_ATTENTION_DEFAULT_VALUE: any;
  IMG_SRC: string;
  NUMBER_DAYS: number;
};

export const CatalogConfig: ICatalogConfig = {
  ORGANIZATION_DEFAULT_VALUE: 21,
  LEGAL_PERMISSION_DEFAULT_VALUE: [
    {
      legalPermission: 1,
    },
  ],
  TYPE_ATTENTION_DEFAULT_VALUE: [
    {
      typeAttention: 1,
    },
  ],
